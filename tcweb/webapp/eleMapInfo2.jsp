...
<div id ="testMaptj" region="south" split="false" title="区域统计" style="padding:0px;height:250px;"></div>
...
function PolygonCenter(pl,areaName){
  ...
  //   alert(plCenterlat/path.length);
     ...
     if(areaName!="成都市"){
         if(areaName=="武侯区"){
        	 var label = new BMap.Label(areaName+":"+areaEtotal+"<br>"+"("+areaEtotalp+"%"+")"+"<br>"+"高新区"+":"+gxetotal+"<br>"+"("+gxetotalp+"%"+")",  { offset: new BMap.Size(-15, 2) });
             }
         else{
