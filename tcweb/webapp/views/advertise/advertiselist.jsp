...
$.fn.datebox.defaults.formatter = function(date){ 
     ...
     function query(){
    	 ...
    	 grid.datagrid("options").url='/tcweb/advertise/query';
         grid.datagrid("options").queryParams={'area':area,'address':address,'buildingName':buildingName,'deviceId2':deviceId2};
         $('#dtt').datagrid('reload');
         }
	 </script>
<style type="text/css">
...
<td>门贴广告</td>
   <td><select id="deviceId2"   name="deviceId2" style="width:100px;">
   <option value="0"></option>
   <option value="1">已关联</option>
   <option value="2">未关联</option></select></td>
 <td colspan="2">
