...
$(function(){
	...
	grid=$('#systongjitt').datagrid({
	    ...
	    url:'/tcweb/elevator/zjsystongji',
	    queryParams:{},
	    columns:[[{"title":"统计时间:"+'<%=tjtime%>',"colspan":8}],
	     	    [
	        {field:'jdbCompanyName',align:'center',title:'乡镇/街道办',width:$(this).width() * 0.124},
	        {field:'etotal',align:'center',title:'电梯数量',width:$(this).width() * 0.124},
	        {field:'setotal',align:'center',title:'停用数量',width:$(this).width() * 0.124},
	        {field:'ncqetotal',align:'center',title:'维保超期数量',width:$(this).width() * 0.124,formatter: function(value,rec,index) {
                ...
                if (value > 0){
		         ...
		         {field:'tsrtotal',align:'center',title:'投诉数量',width:$(this).width() * 0.124},
				 {field:'undotsrtotal',align:'center',title:'投诉未处理',width:$(this).width() * 0.124,formatter: function(value,rec,index) {
				            var townshipStreets = rec.townshipStreets;
			                if (value > 0){
			    ...
			    {field:'nutotal',align:'center',title:'投诉未处理率(%)',width:$(this).width() * 0.124,formatter: function(value,rec,index) {
	        ...
	        {field:'cql',align:'center',title:'维保超期率(%)',width:$(this).width() * 0.124,formatter: function(value,rec,index) {
...
//	$('#registNumberMap').html(registNumber);
     gridncqetotal=$('#tncqetotal').datagrid({
	    ...
	    url:'/tcweb/elevator/ncqetotallist2zjByOrder',
...
//	$('#registNumberMap').html(registNumber);
     gridundotsrtotal=$('#undotsrtotal').datagrid({
	    ...
	    pageSize:10,
	    pageList:[10,20,30,40],
	    url:'/tcweb/elevator/undotsrtotallist2zjByOrder',
	    queryParams:{'townshipStreets':townshipStreets},
	    frozenColumns:[[
	                    {field:'registNumber',title:'电梯编号↑↓',sortable : true,width:80},
	                    {field:'address',title:'地址↑↓',sortable : true,width:160},
...
function undotsrquery(){
	var registNumber=$('#registNumber').attr("value");
    var buildingName=$('#buildingName').attr("value");
    gridundotsrtotal.datagrid("options").url='/tcweb/elevator/undotsrquery2zjByOrder';
