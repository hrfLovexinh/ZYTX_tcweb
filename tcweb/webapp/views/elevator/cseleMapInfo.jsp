...
<div region="north" split="false" title="" style="height:30px;">

	<div style="background-color:#F0F8FF">
	    <a href="#" class="easyui-linkbutton" onclick="showcontent('alarm')" data-options="iconCls:'icon-undo'">报警电梯</a>
		<a href="#" class="easyui-linkbutton" onclick="showcontent('tousu')" data-options="iconCls:'icon-large-smartart'">投诉电梯</a>
		<a href="#" class="easyui-linkbutton" onclick="showcontent('all')" data-options="iconCls:'icon-sum'">所有电梯</a>
	<!--  
        <a href="javascript:void(0)" onclick="showcontent('alarm')" class="easyui-linkbutton" style="width:20px" data-options="iconCls:'icon-large-picture',size:'large',iconAlign:'top'">报警电梯</a>
        <a href="javascript:void(0)" onclick="showcontent('tousu')"  class="easyui-linkbutton" style="width:20px" data-options="iconCls:'icon-large-shapes',size:'large',iconAlign:'top'">投诉电梯</a> 
        <a href="javascript:void(0)" onclick="showcontent('all')" class="easyui-linkbutton"   style="width:20px"  data-options="iconCls:'icon-large-chart',size:'large',iconAlign:'top'">所有电梯</a> 
    -->
    </div>
   
		
	</div>
<div id="testMap" region="center" title="" style="padding:5px;"></div>
...
map.centerAndZoom(new BMap.Point(112.932, 28.1890), 11); //初始化地图，设置中心点坐标和地图级别
...
map.setCurrentCity("长沙"); //设置地图显示的城市，这项是必须的
