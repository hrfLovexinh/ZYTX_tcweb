...
$(function(){
	...
	*/
	...
	gjquerywin = $('#gjquery-window').window({  closed:true,draggable:true,modal:false,onClose:function(){gjquerywinsave();} });
...
<div id="gjquery-window" title="高级查询" style="width:420px;height:460px;overflow-x:hidden;overflow-y:auto">
   ...
   <option value="彭州">彭州</option>
        ...
        <tr>  
            <td>维保合同有效期</td><td>从<input  id="qmContractVdate" name="qmContractVdate"  type="text" class="easyui-datebox"></input>到<input  id="qmContractVdate2" name="qmContractVdate2" type="text" class="easyui-datebox"></input></td>
        </tr>
        <tr>  
            <td>检验日期</td><td>从<input  id="qinspectDate" name="qinspectDate"  type="text" class="easyui-datebox"></input>到<input  id="qinspectDate2" name="qinspectDate2" type="text" class="easyui-datebox"></input></td>
        </tr>
    ...
    <option value="杂物电梯">杂物电梯</option>
        ...
        <tr>  
         ...
         <tr>  
            <td>投用日期</td><td>从<input  id="quseDate" name="quseDate"  type="text" class="easyui-datebox"></input>到<input  id="quseDate2" name="quseDate2" type="text" class="easyui-datebox"></input></td>
        </tr>
        <tr>  
