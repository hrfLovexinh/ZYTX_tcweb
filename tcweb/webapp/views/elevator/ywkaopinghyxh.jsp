...
$(function(){
	...
	$('#kptb').datagrid({   
	    url:'/tcweb/elevator/kpinfoListMul',   
	    columns:[[  
	        {field:'ywCompanyName',title:'运维公司',align:'center',width:$(this).width() * 0.32},
	        {field:'scoreTotal',title:'评分总计',align:'center',width:$(this).width() * 0.32,formatter: function(value,rec,index) {
	      ...
	      //  {field:'ratingUserName',title:'评分人',align:'center',width:$(this).width() * 0.24},   
	        {field:'detailratingDate',title:'评分时间',align:'center',width:$(this).width() * 0.32,formatter: function(value,rec,index) {
	        	if(value!=null)
...
function query(){
	/*
	   ...
	   */
	    ...
	    $('#kptb').datagrid("options").url='/tcweb/elevator/queryKpinfoListMul';
	    $('#kptb').datagrid("options").queryParams={'ywCompanyId':ywCompanyId,'ratingDate':ratingDate};
...
<div region="north" style="overflow:hidden;background-color:rgb(201,220,245);">  
       ...
       <!--  <td nowrap height="70px">考评单位：</td>
        ...
        <td><a href="#" class="easyui-linkbutton" icon="icon-no" onclick="clearQuery()">清空</a></td>  
       </tr>
       </table>
       </center>
</div>
