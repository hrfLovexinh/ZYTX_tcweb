...
if(user!=null){
  if(user.getPassword().equals(password)){
	  System.out.println(user.getLoginName()+"csywRanking登陆成功");
	  role = user.getRole();
...
$(function(){
	...
	//    pageSize:40,
	    ...
	    queryParams:{},
	    columns:[[{"title":"统计时间:"+'<%=tjtime%>',"colspan":20}],
	     	    [
            {field:'ywCompanyName',title:'维保单位',width:150,align:'center'},
	        ...
	        {field:'tScore',title:'综合得分',width:80,align:'center'},
...
<!--   <div region="north"  border="0" style="height:50px;">
