...
<% double map_x =Double.parseDouble(request.getParameter("map_x"));
   ...
   double map_x1 =Double.parseDouble(request.getParameter("map_x1"));
   double map_y1 =Double.parseDouble(request.getParameter("map_y1"));
   double map_x2 =Double.parseDouble(request.getParameter("map_x2"));
   double map_y2 =Double.parseDouble(request.getParameter("map_y2"));
  ...
  System.out.println("map_x1---"+map_x1);
  System.out.println("map_y1---"+map_y1);
  System.out.println("map_x2---"+map_x2);
  System.out.println("map_y2---"+map_y2);
  /*
  if(0.0==longitude)
	  longitude=104.06;
  if(0.0==latitude)
...
if(point_x1>0 && point_y1>0){
    point1 = new BMap.Point(point_x1, point_y1);
//	map.centerAndZoom(point1, 15); // 初始化地图，设置中心点坐标和地图级别   
    map.panTo(point1);
	}
if(point_x2>0 && point_y2>0){
    point2 = new BMap.Point(point_x2, point_y2);
...
var infowindow0 =crateInfo("运维开始前");
...
if(point1){ 
var iconImg1 = createIcon(); 
var infowindow1 =crateInfo("运维开始");
var marker1 = new BMap.Marker(point1,{icon:iconImg1});        // 创建标注
...
if(point2){
var iconImg2 = createIcon();
var infowindow2 =crateInfo("运维结束");
var marker2 = new BMap.Marker(point2,{icon:iconImg2});        // 创建标注
