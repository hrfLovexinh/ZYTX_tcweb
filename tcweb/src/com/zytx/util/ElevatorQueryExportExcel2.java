...
public class ElevatorQueryExportExcel2<T> {
     ...
     // 数据库中存储的数据行  
        ...
        for (int j = 0; j < export_times; j++) { 
        	try {
				...
				list = ElevaltorQueryExportVO.findBySql(ElevaltorQueryExportVO.class, sql, null,null,page_size, j*page_size);
			...
			//            T t = (T) it.next(); 
				 ...
				 for (int i2 = 0; i2 < len; i2++) {   
					 ...
					 ElevaltorQueryExportVO t =list.get(i2);  
			//		 T t = (T)list.get(i2); 
