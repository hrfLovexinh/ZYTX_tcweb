...
public class YwstatExportExcel<T> {
	private int  hjetotal  =0;
	private int  hjeywtotal =0;
	private int hjdailingetotal =0;
	private int hjuncqetotal =0;
	private int hjncqetotal =0;
     ...
     // 生成并设置另一个样式,用于设置内容样式  
      ...
      //获取工作表最后一行  
        ...
        for(int i = 0; i<dataset.size();i++){
        	this.hjetotal=this.hjetotal+ Integer.parseInt(sheet.getRow(i+2).getCell(1).getStringCellValue());
        	this.hjeywtotal=this.hjeywtotal+ Integer.parseInt(sheet.getRow(i+2).getCell(2).getStringCellValue());
        	this.hjdailingetotal=this.hjdailingetotal+ Integer.parseInt(sheet.getRow(i+2).getCell(3).getStringCellValue());
        	this.hjuncqetotal=this.hjuncqetotal+ Integer.parseInt(sheet.getRow(i+2).getCell(4).getStringCellValue());
        	this.hjncqetotal=this.hjncqetotal+ Integer.parseInt(sheet.getRow(i+2).getCell(5).getStringCellValue());
        }
       
        sumCell1.setCellValue(new HSSFRichTextString(String.valueOf(this.hjetotal))); 
        sumCell2.setCellValue(new HSSFRichTextString(String.valueOf(this.hjeywtotal)));
        sumCell3.setCellValue(new HSSFRichTextString(String.valueOf(this.hjdailingetotal)));
        sumCell4.setCellValue(new HSSFRichTextString(String.valueOf(this.hjuncqetotal)));
        sumCell5.setCellValue(new HSSFRichTextString(String.valueOf(this.hjncqetotal)));
