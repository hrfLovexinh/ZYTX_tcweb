...
/** userInfo . */
@Table(name = "TwoCodeNewYuanShiData")
public class NewDdYuanShiElevaltorInfoVO extends YuanShiActiveRecordBase {
...
//	private java.sql.Date pasteTime;
	...
	public String getWgContactor() {
		return wgContactor;
	}

	public void setWgContactor(String wgContactor) {
		this.wgContactor = wgContactor;
	}
	...
	public String getYwLevel() {
		return ywLevel;
	}

	public void setYwLevel(String ywLevel) {
		this.ywLevel = ywLevel;
	}

	public String getYwContactor() {
		return ywContactor;
	}

	public void setYwContactor(String ywContactor) {
		this.ywContactor = ywContactor;
	}
	...
	public String getTownshipStreetsName() {
		return townshipStreetsName;
	}

	public void setTownshipStreetsName(String townshipStreetsName) {
		this.townshipStreetsName = townshipStreetsName;
	}
